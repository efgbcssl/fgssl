            ...
            <div className="w-full max-w-md bg-white rounded-xl shadow-lg overflow-hidden p-8 text-center">
                ...
                <div className="space-y-4">
                    <button
                        ...
                        className="w-full btn btn-primary flex items-center justify-center gap-2 py-3 px-4"
                    >
                    ...
                    <button
                        ...
                        className="w-full btn btn-secondary flex items-center justify-center gap-2 py-3 px-4"
                    >
                        <svg className="w-5 h-5" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
